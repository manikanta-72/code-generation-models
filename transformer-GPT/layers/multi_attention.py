...
class MultiAttention(nn.Module):
    ...
    def __init__(self, d_model = 512, n_heads = 8, enable_mask = False):
        ...
        self.attention_heads = [SelfAttention(self.d_model, self.d_k, self.d_v, enable_mask) for i in range(self.n_heads)]
